...
fn binary_operators() {
    let source = "fn main() {
        111111111111111111 - 11111111111111111 + 1111111111111111 * 2222222222222222
         + 11111111111111111;
        111111111111111111 * 11111111111111111 + 1111111111111111 - 1111111111111111
         + 2222222222222222 * 333333;
        }";
    assert_eq!(
        format_str_config(source, Config::default().max_width(48)).unwrap(),
        "
fn main() {
    111111111111111111
        - 11111111111111111
